...
**🤖 Recommended project:** [AgentCode](https://github.com/study8677/agentcode) — turns real development tasks and AI PR review into a practice ground for the engineering delivery skills that matter in the Agent era; the project is currently polishing V0, and PRs and issues are welcome.
...
> 📝 **English translation coverage** — **34 of 40 tutorial chapters, all 31 templates, and the first 6 cases** are available in English. Use the language switch (top-right on the site), or browse `en/` in the repo.
